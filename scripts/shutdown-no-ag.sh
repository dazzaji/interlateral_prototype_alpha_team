#!/usr/bin/env bash
# shutdown-no-ag.sh - Stop CC/Codex/Gemini sessions and local support services
#
# Usage:
#   ./scripts/shutdown-no-ag.sh
#   ./scripts/shutdown-no-ag.sh --force-port-kill
...
echo "============================================"
echo "  INTERLATERAL SHUTDOWN (No AG)"
echo "============================================"
echo ""
